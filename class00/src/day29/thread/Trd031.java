...
public class Trd031 extends Thread {
	/*
		...
		구분방법은 여러가지가 있을 수 있다.
			...
			이 때는 상위 클래스인 Thread의 Thread(String name) 생성자를 이용하면 된다
			
				즉, 상위 클래스의 디폴트 생성자가 아닌
	...
	public Trd031(String name) {
		super(name);
		// new 시킬 때 이름을 정해주고 이름을 입력받아서 스레드의 이름을 정하는 방법
	}
	@Override
	public void run() {
		/*
