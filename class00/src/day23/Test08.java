...
//			System.out.println(f1.getArea()+" : " /* +f1.getWidth() */);
	...
	public void func02(ArrayList<? extends Figure> list) {
		/*
		 	이 함수는 Figure로 제너릭 선언된 ArrayList와
	...
	//모든 제너릭 선언된 ArrayList를 모두 받는다. 그냥 Object로 보면 됨.
	public void func04(ArrayList<?> list) {
		for(int i = 0 ;i<list.size(); i++) {
